...
* Add the yum repo file that points to a network resource
...
* Deploy this image on another LUN
  ...
  `qemu-img convert new_rhel.qcow /path/to/new/lun`

* Use this new LUN as a storage device and boot up new partition
