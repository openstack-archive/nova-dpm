...
class DPMDriver(driver.ComputeDriver):
    ...
    def spawn(self, context, instance, image_meta, injected_files,
        ...
        # TODO(preethipy): VNic attachment code should be uncommented
        # once the neutron agent code is ready to use
        ...
        # TODO(preethipy): build resources code should be uncommented
        # when cinder driver is ready to use. This code is expected to
        # trigger Volume creation which is used for booting the Instance
