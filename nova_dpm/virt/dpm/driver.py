...
class DPMDriver(driver.ComputeDriver):
    ...
    def get_volume_connector(self, instance):
        ...
        discovers the instances LUNs to see which storage paths are active.
        """
    ...
    def spawn(self, context, instance, image_meta, injected_files,
        ...
        hba_uri = inst.get_hba_uri(self._conf)
    ...
    def _fetch_valid_target_wwpn(self, mapped_block_device, partition_wwpn):
        ...
        target_wwpn = str(target_wwpns[0]
                          if len(target_wwpns) > 1 and target_wwpns[0] else '')
