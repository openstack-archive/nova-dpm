...
from nova_dpm.compute import hv_type
...
class Host(object):
    ...
    def properties(self):
        ...
        if not self._properties:
            LOG.warning(_LW('properties is none'))
    ...
    def _get_host_poperties(self):
        ...
        dict_mo = {
            ...
            "dpm_name": self._managedobj.properties['name'],
            "disk_available_least": 1024,
            'supported_instances':
            [("s390", hv_type.PRSM, obj_fields.vm_mode.HVM)]}
