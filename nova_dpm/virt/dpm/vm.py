...
DESCRIPTION_PREFIX = OPENSTACK_PREFIX + ' CPCsubset='
OPENSTACK_INSTANCE_PREFIX = OPENSTACK_PREFIX + '-Instance-'
...
class Instance(object):
    ...
    def partition_name(self):
        ...
        """
        return OPENSTACK_INSTANCE_PREFIX + self.instance.uuid

    def properties(self):
        properties = {}
        properties['name'] = self.partition_name
        properties['description'] = DESCRIPTION_PREFIX + CONF.host
