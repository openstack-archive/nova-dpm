...
class HostTestCase(TestCase):
    ...
    def test_host_properties(self):
        ...
        self.assertEqual(utils.MAC_PROC, host_properties['vcpus_used'])
        self.assertEqual(utils.TOTAL_MEM, host_properties['memory_mb_used'])
    ...
    def test_get_proc_used(self):
        ...
        self.assertEqual(utils.MAC_PROC, proc_used)

    def test_mem_used(self):
        memory_used = self.host._get_mem_used()
        self.assertEqual(utils.TOTAL_MEM, memory_used)
